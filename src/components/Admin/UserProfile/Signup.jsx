    ...
    return (
        <div className="container signup-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row mb-3">
                    <div className="col-md-4">
                        ...
                        <input type="text" className="form-control" id="state" name="state"
                            placeholder="State" value={formData.state} onChange={handleInputChange}/>
                    ...
                    <div className="col-md-4">
                        ...
                        placeholder="District" value={formData.district} onChange={handleInputChange}/>
                ...
                <div className="row mb-3">
                    <div className="col-md-4">
                        ...
                        <input type="text" className="form-control" id="pincode" name="pincode"
                         placeholder="Pincode" value={formData.pincode} onChange={handleInputChange}/>
                        {errors.pincode && <div className="text-danger">{errors.pincode}</div>}
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="landmark" className="form-label">Landmark</label>
                        <input type="text" className="form-control" id="landmark" name="landmark"
                        placeholder="Landmark" value={formData.landmark} onChange={handleInputChange}/>
                ...
                <button type="submit" className="btn btn-primary" style={{background: "#22B6AF", border:"none"}}>Submit</button>
            </form>
        </div>
    );
};
